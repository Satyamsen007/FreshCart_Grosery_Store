...
import { fetchAllProducts, setFilters } from '@/store/features/getAllProductsSlice';

export const useAllProductsRedux = (page = 1, limit = 15) => {
  ...
  useEffect(() => {
    ...
    dispatch(fetchAllProducts({ ...queryParams, signal: controller.signal }));
