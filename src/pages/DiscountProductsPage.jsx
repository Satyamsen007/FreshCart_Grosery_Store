...
import { fetchDiscountProducts, resetFilters, setFilters, setPage } from '@/store/features/getDiscountProductsSlice';
    ...
    <div className="px-4 py-8 w-[90%] mx-auto dark:bg-gray-900">

      {
        status === 'loading' ? (
          ...
          <div className='mb-5 xl:w-[20%] max-md:w-[70%] md:w-[40%] max-sm:mx-auto'>
            <h1 className="text-2xl font-semibold text-[var(--textColor)] mb-1 dark:text-gray-100">Our Discount Products</h1>
            <span className="block w-full h-1 bg-gradient-to-r from-[var(--primaryColor)] dark:from-[#FFB74D] rounded-md to-transparent"></span>
          </div>
        )
      }

      <div className='flex items-center justify-between max-sm:justify-center max-sm:flex-col'>
        <div className='flex flex-col gap-5'>
          {
            status === 'loading' ? (
              <div className="flex items-center gap-2 mb-3 text-lg font-semibold text-[var(--textColor)]">
                <Skeleton className="h-5 w-5 rounded-full bg-[var(--primaryColor)]/50 dark:bg-gray-700" />
                <Skeleton className="h-5 w-40 rounded-md bg-[var(--primaryColor)]/50 dark:bg-gray-700" />
              </div>
            ) : (
...

      {
        status === 'loading' ? (
          <div className="flex flex-wrap gap-6 mb-6">
            ...
            <div className="flex flex-col gap-2">
              <Skeleton className="w-24 h-10 bg-[var(--primaryColor)]/50 rounded-md dark:bg-gray-700" />
            </div>
            <div className="flex flex-col gap-2">
              <Skeleton className="w-24 h-10 bg-[var(--primaryColor)]/50 rounded-md dark:bg-gray-700" />
            </div>
          ...
          <div className="flex flex-wrap max-sm:items-center max-sm:justify-center gap-6 mb-6">
            <Select
              disabled={isLoading}
            ...
            >
              <SelectTrigger className="w-40 text-white font-medium border cursor-pointer border-[var(--textColor)]/30 dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800 [&>span]:dark:text-gray-400">
            ...
            >
              <SelectTrigger className="w-fit border cursor-pointer border-[var(--textColor)]/30 dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800 [&>span]:dark:text-gray-400">
                <SelectValue placeholder="Price" />
              </SelectTrigger>
              <SelectContent className="dark:bg-gray-800 dark:border-gray-700">
                {priceFilterOptions.map((option, i) => (
                  <SelectItem className='cursor-pointer text-[var(--textColor)] dark:text-gray-300 hover:dark:bg-gray-700' key={i} value={option.value}>{option.label}</SelectItem>
                ))}
              </SelectContent>
            </Select>
            ...
            >
              <SelectTrigger className="w-fit cursor-pointer border border-[var(--textColor)]/30 dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800 [&>span]:dark:text-gray-400">
